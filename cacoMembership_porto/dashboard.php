                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <a href="./resetPaassword.php" class="dropdown-item">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Users</span></a>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Roles</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./roles.php">Manage</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <?php
                           $countv = mysqli_query($connect,"select role_id from roles") or die(mysqli_error($connect));
                                $countv = mysqli_num_rows($countv);
                                    if(empty($countv) >= 0){  ?>
                                    <div class="stat-digit"> <i class="fa fa-dashboard"></i><?php echo $countv;?></div>
                                    <?php }?>
