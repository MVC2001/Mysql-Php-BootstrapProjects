    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0F5091 ;">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./weeklyReport.php">Manage</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./studentResults.php">Manage</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="./changePasswordV4.php">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1" style="font-size:20px">
                                               ...
                                               <?php 
$query = "SELECT training.supervisor 
          FROM training 
...
if ($row = mysqli_fetch_assoc($result)) {
    echo "YOUR SUPERVISOR: " . $row['supervisor'];
} else {
    echo "No supervisor found for the given user.";
}
?> 
& 

   <?php 
$query = "SELECT training.trainer 
          FROM training 
          JOIN user ON training.fullName = user.fullName 
          WHERE user.user_id = '".$_SESSION['user_id']."' 
          LIMIT 1";
