...
function updateUser($connect,$user_id, $fullName,$role,$course, $status,$email) {
   

    // Update user in the database
    $updateQuery = mysqli_query($connect, "UPDATE `user` SET  `fullName`='$fullName',`role`='$role',`course`='$course',`status`='$status',`email`='$email' WHERE `user_id`='$user_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    $result = updateUser($connect,$user_id, $fullName,$role,$course, $status,$email);
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <button type="submit" name="update-function" class="btn btn-primary mb-2" style="background-color:#0F5091">update</button>
                                    </form>
