...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($activities as $activity) {
        $sql = "INSERT INTO fieldreport (fullName, trainer,supervisor, report_date, activity, comment) VALUES ('$fullName', '$trainer','$supervisor', '$reportDate', '$activity', '$comment')";
    ...
    header("Location: dailReport.php");
    exit();
}
?>
...
<body id="page-top">
                                ...
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                 <input required name="fullName" type="hidden" class="form-control" placeholder="Enter full name" <?php 
                                          ...
                                          $number = mysqli_num_rows($result);
                                           ...
                                           <?php } } ?>
                                            ...
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                  <input required name="supervisor"  type="hidden" class="form-control" placeholder="Enter full name" 
                                                  <?php 
                                          $select_all_roles = "SELECT training.supervisor 
          FROM training 
          JOIN user ON training.fullName = user.fullName 
          WHERE user.user_id = '".$_SESSION['user_id']."' 
          LIMIT 1" or die(mysqli_error($connect));
                                          $result = mysqli_query($connect,$select_all_roles);
                                          $number = mysqli_num_rows($result);
                                             if ($number > 0) {
                                           while($row = mysqli_fetch_assoc($result)) { ?>
                                           ...
                                           <?php } } ?>
                                             ...
                                             <div class="col-sm-4 mt-2 mt-sm-0">
                                                  <input required name="trainer"  type="hidden" class="form-control" placeholder="Enter full name" 
                                                  <?php 
                                          $select_all_roles = "SELECT training.trainer FROM training  JOIN user ON training.fullName = user.fullName  WHERE user.user_id = '".$_SESSION['user_id']."'  LIMIT 1" or die(mysqli_error($connect));
                                          $result = mysqli_query($connect,$select_all_roles);
                                          $number = mysqli_num_rows($result);
                                             if ($number > 0) {
                                           while($row = mysqli_fetch_assoc($result)) { ?>
                                ...
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                <input name="report_date"  type="date" class="form-control"  placeholder=" Enter report_date">
                                            </div>
                           
                                            
                                            <div class="col-sm-6 mt-2 mt-sm-0" id="activityContainer">
                                ...
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-12 mt-2 mt-sm-0">
                                             <textarea name="comment" required  type="text" class="form-control"  placeholder=" Enter info on activities you do"></textarea>
                                            </div>
                                        </div>
    ...
    <!-- JavaScript code to add more activity fields -->
 <script>
