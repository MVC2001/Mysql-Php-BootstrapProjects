...
if (isset($_POST['login'])) {
    ...
    $confirmPassword = md5($_POST['conf-password']); 
        ...
        if ($row > 0) {
            ...
            switch ($role) {
                ...
                case 'station_manager':
                    $redirectUrl = 'station_manager.php';
                    break;
                default:
      ...
      <div class="card border-light-subtle shadow-sm">
        <div class="row g-0">
          <div class="col-12 col-md-6">
            <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="./assets/imgs/loginImg.png" alt="BootstrapBrain Logo">
          </div>
          <div class="col-12 col-md-6">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <form action="" method="POST">
                <div class="row gy-3 gy-md-4 overflow-hidden">
                  ...
                  <div class="col-12">
                    <label for="password" class="form-label">Comfirm-Password <span class="text-danger">*</span></label>
                    <input type="password" class="form-control" name="conf-password" id="password" value="" required>
                  </div>
                 
                  <div class="col-12">
                    <div class="d-grid">
                      <button class="btn bsb-btn-xl text-white btn-" name="login" type="submit" style="background-color: #0A2D54;">Log in now</button>
                    </div>
                  </div>
                </div>
              </form>
