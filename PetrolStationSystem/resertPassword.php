...
<div class="sidebar" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
    <ul class="text-center" style="margin-top: 80px;"><br>
        ...
        <li><a href="#"  style="color: white;font-size: 20px;font-family: sans-serif;font-weight:bold;">ViewStations</a></li>
    </ul>
</div>
    ...
    <form action="" method="post">
         ...
         <div class="col-sm-6">
          ...
          <div class="row py-2 align-items-center g-3">
              ...
              <span><a href="./dashboard.php"><button type="button" class="btn btn-block" style="background-color:#543B0A ;width:230px;color:white">Cancel</button></a></span>
          </div>
    </div>
</div>
