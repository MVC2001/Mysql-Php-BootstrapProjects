...
<div class="sidebar" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
    <ul class="text-center" style="margin-top: 80px;"><br>
        <div class="card text-success" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;"><h4>GUEST USER</h4></div>
       
    </ul>
</div>

<div class="main-content text-center shadow-sm" style="margin-top: 20px;background-color: #0A2D54;">
                <p style="color:white;font-size:30px">YOUR SUCCESFULL CREATE NEW ACCOUNT BUT, CALL THIS NO# 068231140 For Account Activation</p>
