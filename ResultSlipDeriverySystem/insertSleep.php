...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        $insertQuery = mysqli_query($connect, "INSERT INTO `resultsleep_tbl` (`fullName`, `indexNo`, `sleep_file`, `status`,`school`) VALUES ('$fullName', '$indexNo', '$sleepFileName', '$status','$school')");
