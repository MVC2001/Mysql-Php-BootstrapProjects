...
$query = mysqli_query($connect, "SELECT * from resultsleep_tbl where  approved !='approved'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary btn-block" style="width:300px;background-color:#11517c;"><a href="insertSleep.php">AddNew-Slip</a></button>
                            </div>
                            <div class="card-body">
...
<?php foreach ($results as $result) : ?>
                <tr>
                    ...
                    <td><?php echo $result['sleep_file']; ?></td>
                    <td><?php echo $result['school']; ?></td>
                    <td><?php echo $result['status']; ?></td>
                     <td><?php echo $result['created_at']; ?></td>
                    <td>
                        <!-- Buttons for delete, update, and download -->
                        <form action="downloadSleep.php" method="POST" style="display: inline;">
                        ...
                        <a href="sendSleepToStudent.php?id=<?php echo $result['id']; ?>" class="btn btn-info btn-sm">Send-Sleep</a>
                     <form action="deleteSleep.php" method="POST" style="display: inline;">
                            <input type="hidden" name="fullName" value="<?php echo $result['fullName']; ?>">
                            <input type="hidden" name="indexNo" value="<?php echo $result['indexNo']; ?>">
