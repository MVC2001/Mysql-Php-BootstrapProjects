        ...
        <div class="quixnav" style="background-color:#11517c;">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first">ROLES-LISTS</li><hr>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary btn-block" style="width:300px;background-color:#11517c;"><a href="addRole.php">AddNew-Role</a></button>
                            </div>
                            <div class="card-body">
