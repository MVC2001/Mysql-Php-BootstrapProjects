                   ...
                   <br>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./clearanceForms.php">Back-now</a></li>
                    </li>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                             ...
                                             <div class="col-sm-12">
                                             <input name="yearOfStudy" required type="text" class="form-control" placeholder="Enter year of study eg. 2018">
                                        </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-12 mt-2 mt-sm-0">
                                <textarea name="description" required type="text" class="form-control" placeholder=" Enter more exxplanation"></textarea>
                                            </div>
