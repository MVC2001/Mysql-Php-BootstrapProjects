        ...
        <div class="quixnav" style="background-color:#11517c;">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first">ROLES-REGISTRATION</li><hr>
                                          ...
                                          <option value="None-user">--Selct-----role--------</option>
                                           ...
                                           <option value="head_of_school">Head of school</option>
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                             <textarea type="text" class="form-control" required name="description" placeholder="Enter description"></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <button type="submit" name="add-function" class="btn btn-primary mb-2">Create role</button>
                                    </form>
                                </div>
                            </div>
                        </div>
