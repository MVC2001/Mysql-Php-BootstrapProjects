                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary btn-block" style="width:300px;background-color:#11517c;"><a href="users-registration.php">AddNew-User</a></button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `users` WHERE `role` = 'admin' OR `role` = '' and validy_student !='validy_student' ORDER BY user_id DESC";
