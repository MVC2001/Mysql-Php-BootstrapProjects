        ...
        ***********************************-->
        <div class="nav-header" style="background-color:#032B58">
            <a href="#" class="brand-logo">
                <img class="logo-abbr shadow-lg" src="./cacoimgs/cacologo.jpg" alt="" style="height:50px;width:100px">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                 <a href="./resetPaasswordV1.php" class="dropdown-item">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">New Members</span></a>
                        <ul aria-expanded="false">
                            <li><a href="newMembers.php">Manage</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Approved Members</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./approvedMembers.php">Manage</a></li>
                        </ul>
                    </li>

                      <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">AnnounceMents</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./announcements.php">Manage</a></li>
                        </ul>
                    </li>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">New Mmbers</div>
                                      <?php
                           $countv = mysqli_query($connect,"select member_id  from membership_tbl where status != 'approved'") or die(mysqli_error($connect));
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Approved Members</div>
                                    <?php
                           $countv = mysqli_query($connect,"select member_id  from membership_tbl where status='approved'") or die(mysqli_error($connect));
                                $countv = mysqli_num_rows($countv);
                                    if(empty($countv) >= 0){  ?>
