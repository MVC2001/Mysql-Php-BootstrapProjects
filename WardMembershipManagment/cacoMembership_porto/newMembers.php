                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tbody style="color:#032B58">
                                        <?php 
                                        $count = 1;
                                        $select_all_users = "SELECT * FROM membership_tbl where status !='approved'  ORDER BY member_id DESC";
                                        ...
                                        if ($number > 0) {
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="approveMember.php?member_id=<?php echo $row['member_id'] ?>">
                                            ...
                                            <tr>
                                                <td colspan="10">No new member found</td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
