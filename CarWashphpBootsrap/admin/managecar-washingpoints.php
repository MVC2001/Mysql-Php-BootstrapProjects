...
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					    <table id="table" class="table table-stripped shadow" style="font-size:11px;width:850px">
						<thead>
						  <tr>
						  <th>#</th>
...
{				?>		
						  <tr>
							...
							<td>
								<a href="editcar-washpoint.php?wpid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary" style="color:white">Edit</button></a> | <a href="deletecar-washingpoints.php?id=<?php echo htmlentities($result->id);?>" style="color:red;" onClick="return confirm('Do you really want to delete');"><button class="btn btn-danger" style="color:white">Delete</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
