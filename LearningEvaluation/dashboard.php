    ...
    <div class="d-flex">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
            ...
            <div class="card text-center" style="height:100px;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                          <hr><a href="./allUsers.php"><i class="fa fa-users"></i>Users</a>
                             <?php
                           $countv = mysqli_query($connect,"select user_id from user") or die(mysqli_error($connect));
             ...
             <div class="col-md-4">
            <div class="card text-center" style="height:100px;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                          <hr><a href="./allquestionnare.php"> <i class="fa fa-list"></i> List Questions</a>
                             <?php
                           $countv = mysqli_query($connect,"select question_id from questions") or die(mysqli_error($connect));
                                $countv = mysqli_num_rows($countv);
                                    if(empty($countv) >= 0){  ?>
                                    <div class="stat-digit"><?php echo $countv;?></div>
                                    <?php }?>
             ...
             <div class="col-md-4">
            <div class="card text-center" style="height:100px;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                          <hr> <a href="./allResponses.php"><i class="fa fa-comments"></i> Feedbacks/Answers</a>
                             <?php
                           $countv = mysqli_query($connect,"select user_id from user") or die(mysqli_error($connect));
                                $countv = mysqli_num_rows($countv);
                                    if(empty($countv) >= 0){  ?>
