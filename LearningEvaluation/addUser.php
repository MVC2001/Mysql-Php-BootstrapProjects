...
function addUser($connect, $fullName, $role, $school, $department, $program, $courseCode, $email, $password) {
    ...
    $insertQuery = mysqli_query($connect, "INSERT INTO `user` (`fullName`, `role`, `school`, `department`, `program`, `courseCode`, `email`, `password`) VALUES ('$fullName', '$role', '$school', '$department', '$program', '$courseCode', '$email', '$hashedPassword')");
    if ($insertQuery) {
...
if (isset($_POST['add-function'])) {
    ...
    $result = addUser($connect, $fullName, $role, $school, $department, $program, $courseCode, $email, $password);
    ...
    <div class="d-flex">
         <nav class="sidebar sidebar-sticky" style="background-color: #2E4053; color: white;">
            <ul class="nav flex-column" style="margin-top: 70px;">
                <li class="nav-item">
                    <a class="nav-link active text-white" href="./allUsers.php">
