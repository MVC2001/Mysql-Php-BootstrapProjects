...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if (in_array($fileType, $allowTypes)) {
        if (move_uploaded_file($_FILES["alphabet"]["tmp_name"], $targetFilePath)) {
            $sql = "INSERT INTO alphabet (alphabet, description) VALUES ('$fileName', '$description')";
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Add Alphabet here</h3>
                    <hr>
                    </hr>
                    <div class="tile-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="image">Alphabet:</label>
                                <input type="file" class="form-control-file" required id="image" name="alphabet">
                            </div>
