...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
  $id = $_GET["id"];
  $sql = "SELECT * FROM symbols_tbl WHERE s_id = $id";
  ...
  if ($_FILES["s_upload"]["name"]) {
    ...
    if (in_array($fileType, $allowTypes)) {
      ...
      if (move_uploaded_file($_FILES["s_upload"]["tmp_name"], $targetFilePath)) {
        ...
        $sql = "UPDATE symbols_tbl SET s_upload='$fileName', description='$description' WHERE s_id=$id";
    ...
    $sql = "UPDATE symbols_tbl SET description='$description' WHERE s_id=$id";
    if ($connect->query($sql) === TRUE) {
          ...
          <div class="tile-body">
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="file" class="form-control-file" id="image" name="s_upload">
