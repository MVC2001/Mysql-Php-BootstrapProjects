...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1 style="color: #094469"><i class="fa fa-th-list"></i> All Symbols</h1>
        <a href="./addSymbol.php"><button class="btn btn text-white" style="background-color: #094469;">Add new
            Symbol</button></a>
      </div>
        ...
        <div class="tile">
          <div class="tile-body">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM symbols_tbl ORDER  BY s_id DESC";
                ...
                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><img src="uploads/' . $row["s_upload"] . '" alt="Symbol Image" style="max-width: 100px; max-height: 100px;"></td>';
                    echo '<td> <a href="upateSymbol.php?id=' . $row["s_id"] . '"><button class="btn btn-success">View</button></a>|<a href="deleteSymbol.php?id=' . $row["s_id"] . '"><button class="btn btn-danger">Delete</button></a></td>';
                    echo "</tr>";
                  }
                } else {
                  echo "0 results";
