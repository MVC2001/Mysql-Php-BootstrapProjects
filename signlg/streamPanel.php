...
<body class="app sidebar-mini rtl">
        ...
        <nav class="navbar navbar-expand-lg navbar-light text-white fixed-top"
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup"
                ...
                <div class="navbar-nav">
                    <a class="nav-link" href="#" style="color:white">Welcome:( <b> <?php $query = mysqli_query($connect, "SELECT * FROM `users` WHERE `user_id`='$_SESSION[user_id]'") or die(mysqli_connect_error());
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="carousel-caption">
                                    <h2 style="color:#094469">LESSON 02: VIDEO</h2>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container" style="margin-top:90px">
        <div class="row">
            <?php
      $sql = "SELECT * FROM video_tbl  ORDER BY v_id ASC";
      $result = $connect->query($sql);

      $numIndex = 1; // Initialize the numeric index

      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          echo '<div class="col-md-4">';
          echo '<div class="card mb-3" style="background-color:#094469">';
          echo '<div class="card-header" style="color:white">' . $numIndex . '</div>'; // Display the numeric index
          echo '<video width="320"controls style="max-width: 350px;margin-left:42px; height: 200px;">';
    ...
    <div class="container text-center text-white" style="height:60px;margin-top:10px">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="card" style="background-color:#094469"><a href="./streamForSymmbols.php"
                        style="color:white">01</a></div>
            </div>

            <div class="col-md-2">
                <div class="card" style="background-color:#094469"><a href="./streamPanel.php"
                        style="color:white">02</a></div>
            </div>

            <div class="col-md-2">
                <div class="card" style="background-color:#094469"><a href="./stream_greetings.php"
                        style="color:white">03</a></div>
            </div>
